...
const reportData = {
  "This Month": {
    "All Countries": {
      "All Devices": [
        { date: "09-Jul-2026", impressions: "7514", clicks: "201", ctr: "2.68%", ecpm: "$83.11", revenue: "$42.06" },
        { date: "08-Jul-2026", impressions: "12995", clicks: "347", ctr: "2.67%", ecpm: "$83.05", revenue: "$83.99" },
        { date: "07-Jul-2026", impressions: "12993", clicks: "346", ctr: "2.67%", ecpm: "$82.81", revenue: "$83.35" },
        { date: "06-Jul-2026", impressions: "12991", clicks: "345", ctr: "2.66%", ecpm: "$82.54", revenue: "$82.72" },
        { date: "05-Jul-2026", impressions: "12988", clicks: "344", ctr: "2.65%", ecpm: "$82.26", revenue: "$82.08" },
        { date: "04-Jul-2026", impressions: "12985", clicks: "343", ctr: "2.64%", ecpm: "$81.98", revenue: "$81.45" },
        { date: "03-Jul-2026", impressions: "12995", clicks: "347", ctr: "2.67%", ecpm: "$83.05", revenue: "$83.99" },
        { date: "02-Jul-2026", impressions: "12992", clicks: "346", ctr: "2.67%", ecpm: "$82.74", revenue: "$83.14" },
        { date: "01-Jul-2026", impressions: "12988", clicks: "345", ctr: "2.66%", ecpm: "$82.36", revenue: "$82.28" },
        { date: "22-Jun-2026", impressions: "12455", clicks: "345", ctr: "2.77%", ecpm: "$85.55", revenue: "$82.87" },
        { date: "21-Jun-2026", impressions: "12342", clicks: "344", ctr: "2.79%", ecpm: "$84.11", revenue: "$82.55" },
        { date: "20-Jun-2026", impressions: "12231", clicks: "342", ctr: "2.79%", ecpm: "$82.44", revenue: "$82.22" },
        { date: "19-Jun-2026", impressions: "12123", clicks: "340", ctr: "2.80%", ecpm: "$80.99", revenue: "$81.90" },
        { date: "18-Jun-2026", impressions: "12453", clicks: "348", ctr: "2.79%", ecpm: "$81.87", revenue: "$81.99" },
        { date: "17-Jun-2026", impressions: "12354", clicks: "340", ctr: "2.75%", ecpm: "$81.66", revenue: "$80.35" },
  ...
  "Last 30 Days": {
    "All Countries": {
      "All Devices": [
        ...
        { date: "02-Jul-2026", impressions: "12992", clicks: "346", ctr: "2.67%", ecpm: "$82.74", revenue: "$83.14" },
        { date: "01-Jul-2026", impressions: "12988", clicks: "345", ctr: "2.66%", ecpm: "$82.36", revenue: "$82.28" },
        { date: "30-Jun-2026", impressions: "12985", clicks: "343", ctr: "2.64%", ecpm: "$81.98", revenue: "$81.45" },
        { date: "29-Jun-2026", impressions: "4400", clicks: "195", ctr: "4.43%", ecpm: "$80.09", revenue: "$32.77" },
        { date: "28-Jun-2026", impressions: "12995", clicks: "347", ctr: "2.67%", ecpm: "$83.05", revenue: "$83.99" },
        { date: "27-Jun-2026", impressions: "12990", clicks: "345", ctr: "2.66%", ecpm: "$82.51", revenue: "$82.72" },
        { date: "26-Jun-2026", impressions: "12985", clicks: "343", ctr: "2.64%", ecpm: "$81.98", revenue: "$81.45" },
        { date: "25-Jun-2026", impressions: "12765", clicks: "347", ctr: "2.72%", ecpm: "$83.05", revenue: "$83.99" },
      ],
      Desktop: [
        { date: "09-Jul-2026", impressions: "7514", clicks: "201", ctr: "2.68%", ecpm: "$83.11", revenue: "$42.06" },
        { date: "08-Jul-2026", impressions: "12995", clicks: "347", ctr: "2.67%", ecpm: "$83.05", revenue: "$83.99" },
